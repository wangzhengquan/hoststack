...
static  char *kucker_repo = "/data/kucker";
...
int main(int argc, char *argv[])
{
    ...
    int container_pid = clone(container_main, container_stack+STACK_SIZE, CLONE_NEWIPC | CLONE_NEWPID | CLONE_NEWNS | SIGCHLD, &arg);
    // sleep(5);
